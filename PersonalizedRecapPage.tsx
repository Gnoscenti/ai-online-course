...
const PersonalizedRecapPage: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8 font-sans">
      <h1 className="text-3xl md:text-4xl font-headings font-bold text-gray-800 mb-4">Your Personalized Recap, {recapData.userName}!</h1>
      <p className="text-gray-600 mb-8 font-sans">Last session: {recapData.lastSessionDate}. Let's see how you're progressing!</p>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          ...
          {recapData.progress.map((item, index) => (
            <div key={index} className="mb-4 pb-4 border-b last:border-b-0 last:pb-0 last:mb-0">
              ...
              <p className="text-sm text-gray-500 font-sans">Completed {item.completedModules} of {item.totalModules} modules. Last viewed: {item.lastModule}</p>
            </div>
          ))}
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside text-green-600 font-sans">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-orange-600 font-sans">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                {recapData.achievements.map((achievement, index) => (
                    <div key={index} className="flex flex-col items-center p-4 border rounded-lg bg-gray-50">
                        ...
                        <p className="text-sm font-medium text-gray-700 text-center font-sans">{achievement.name}</p>
                        <p className="text-xs text-gray-500 font-sans">Earned: {achievement.date}</p>
                    </div>
                ))}
            </div>
        ) : (
            <p className="text-gray-500 font-sans">No achievements unlocked yet. Keep learning!</p>
        )}
      </div>
